...
const RecentPost = () => {
    ...
    return (
        <div className="col-lg-4">
            {blogs.slice(0, 1).map(({ id, title, category, likes, parag1, parag2, parag3, parag4, parag5, profile, image1, author, timestamp }) => (
                <div className="post-entry-1 lg" key={id}>
                    ...
                    <h3 className="mb-4 d-block">{parag2}</h3>
                    <p className="mb-4 d-block">{parag3}</p>
                    <h3 className="mb-4 d-block">{parag4}</h3>
                    <p className="mb-4 d-block">{parag5}</p>
